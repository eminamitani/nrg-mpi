...
subroutine reducedDensityMatrixCalculation
  ...
  integer :: previousKeepBasis, previousTotalBasis
  integer :: previousPositionReducedDensity, previousPositionOutput, previousPositionInput, previousPositionEigenvector
  ...
  do i=1,hami%numberOfIteration-hami%startTrancation
     ...
     !$OMP PRIVATE(ikeepPrev1, ikeepPrev2, idiag, previousEndSubspace)&
     !$OMP PRIVATE(presentNumberOfBasis, presentOutput, presentIndexLeft, presentIndexRight)&
     !$OMP PRIVATE(presentReferenceLeft, presentReferenceRight)&
